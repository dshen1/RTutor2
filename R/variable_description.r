...
examples.make.var.txt.from.files = function() {
  txt.file = "D:/libraries/RTutor2/examples/temp_shroudedvar.txt"

  make.var.txt.from.files(dir="D:/libraries/RTutor2/examples/shroudedfees", outfile = txt.file)
 
  txt.file = "D:/libraries/RTutor2/examples/shroudedvar.txt"
  dt = read.var.txt(txt.file)
  
  txt.file = "D:/libraries/RTutor2/examples/bank runs variables.txt"
  dt = read.var.txt(txt.file)
...
examples.translate.var.names.in.code = function() {
  ...
  var.file = "D:/libraries/RTutor2/examples/bank runs variables.txt"
